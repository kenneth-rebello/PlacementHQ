  ...
  _closeDrive(String id) {
    showDialog(
      ...
      if (res) {
        ...
        Provider.of<Drives>(context, listen: false).closeDrive(id).then((_) {
          Navigator.of(context).pop();
          Provider.of<Drives>(context, listen: false).removeDriveFromMemory(id);
        });
      }
    });
  }
